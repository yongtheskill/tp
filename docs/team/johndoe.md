...
* **Documentation**:
  * User Guide:
    * Added documentation for the features `delete` and `find` ([#72](https://github.com/AY2526S2-CS2103T-T17-2/tp/pull/72))
    * Did cosmetic tweaks to existing documentation of features `clear`, `exit` ([#74](https://github.com/AY2526S2-CS2103T-T17-2/tp/pull/74))
  * Developer Guide:
